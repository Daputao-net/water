class Person(object):
    ...
    def __init__(self,name):
        super(Person,self).__init__()#调用父类的过去的方法，现在用object.__init__()就可以。
        self.name=name
    ...
    def __str__(self):
        if self.gun:#空的字符串，列表，字典，元组，集合，零，None,False都为假，其余为真（只要这些东西里面不是空的）
...
class Danjia(object):
    ...
    def __init__(self,max_num):
        ...
        self.max_num=max_num#用来记录子弹的最大容量
